...
class ImageLogger(Callback):
    def __init__(self, exp_dir='./ImageLogger', every_n_train_steps=2000, max_images=16, clamp=True, increase_log_steps=True,
...
class LoraCheckpoint(Callback):
    ...
    def save_lora(self, pl_module, step):
        ...
        lora_state_dict = {k: v for k, v in state_dict.items()}
